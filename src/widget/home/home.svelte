<script lang="ts">
	...
	import MiniCardIntroduction from '../../entities/mini-card-introduction/mini-card-introduction.svelte';
	import MiniCardUploaderContainer from '../../entities/mini-card-uploader-container/mini-card-uploader-container.svelte';
	import HomeHeaderNavigation from '../../features/home-header-navigation/home-header-navigation.svelte';
...
<MiniCardHome {mountListFile}>
	<HomeHeaderNavigation slot="navigator" />
	<MiniCardIntroduction slot="introduction" />
